...
$scope.articles = [
  ...
  art = [
    {number: 8,
      number_title: 'Eight',
      header_title: 'Wangari does all the things eight year old’s do',
      ...
      smn_sass: 'says Maureen Wangari, Chanelle’s mother.',
      girl_says: 'Wangari says she enjoys school very much.',
      girl_quote: '“I love math, numbers are really fun. They help me with golf, you can see how you’re doing in the game, just by using math problems.”'}
  ],
  art = [
    {number: 7,
      number_title: 'Seven',
